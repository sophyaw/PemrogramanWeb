                ...
                <div class="form-row">
                    ...
                    @foreach ($couriers as $key => $value)
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="couriers-{{ $key }}" name="couriers[]" value="{{ $value->code }}">
                            <label class="form-check-label" for="couriers-{{ $key }}">{{ $value->title }}</label>
                        </div>
                    @endforeach
                </div>
            </div>
